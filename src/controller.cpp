...
#include "Assignment2_RT1/Velocity.h"
...
void ControlRobotTrack(const sensor_msgs::LaserScan::ConstPtr &msg)
{
    ...
    ROS_INFO("Right: @[%f]", initial_vel);
    pub.publish(robot_vel);
}

void ManageSpeed(const Assignment2_RT1::Velocity::ConstPtr& speed)
{
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub2 = nh.subscribe("/Velocity", 1, ManageSpeed);
